...
7. **Extend, don't modify.** ext_-Prefix, nur 17 Core-Dateien, Feature Flags für alles.

## VERBOTEN
- ❌ Onyx-Dateien verändern (außer 17 Core-Dateien auf erlaubte Weise)
...
- ❌ Direkt auf main committen (immer über feature/* Branch, lokaler merge)
